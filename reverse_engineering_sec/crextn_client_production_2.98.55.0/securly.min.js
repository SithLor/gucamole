    ...
    return new Promise(function(n, o) {
        chrome.tabs.get(e, function(e) {
            if (e && "loading" == e.status) {
                ...
                if (void 0 !== e.pendingUrl && (-1 != (o = new URL(e.pendingUrl).hostname).indexOf("securly.com") || -1 != o.indexOf("iheobagjkfklnlikgihanlhcddjoihkg"))) return void n(!0);
            }
            n(!1);
        });
    });
...
function takeDenyAction(e, t, n) {
    ...
    n = window.btoa(s);
    var a = window.clusterUrl.replace("/crextn", "") + "/blocked?useremail=" + window.userEmail + "&reason=" + o + "&categoryid=" + t + "&policyid=" + e + "&url=" + n + "&ver=" + window.version + (1 == window.isSubFrame ? "&subFrame=1" : "") + "&extension_id=" + chrome.runtime.id;
...
function addQueryParamToUrl(e, t, n) {
    const o = new URLSearchParams(e.split("?")[1]);
    o.delete(t);
    for(const e in n)o.set(e, n[e]);
    return e.split("?")[0] + "?" + o.toString();
}
function takeCreativeCommonImageSearchAction(e) {
    if (-1 !== e.indexOf("google.co") && -1 !== e.indexOf("tbm=isch")) return -1 === e.indexOf("tbs=il:cl") && addQueryParamToUrl(e, "tbs", {
        tbs: "il:cl"
    });
    if (-1 != e.indexOf("bing.com/images/search") && -1 == e.toLowerCase().indexOf("&qft=+filterui:licenseType-Any")) return addQueryParamToUrl(e, "qft", {
        qft: "+filterui:licenseType-Any"
    });
    return -1 != e.indexOf("images.search.yahoo.com/search/images") && -1 == e.indexOf("&imgl=cc") ? addQueryParamToUrl(e, "imgl", {
        imgl: "cc"
    }) : e;
}
function getYtSSRequestHeaders(e, t) {
    if (-1 != e.indexOf("/results") || -1 != e.indexOf("/search") || -1 != e.indexOf("/watch")) {
        for(var n = "", o = 0; o < t.length; ++o)if ("Cookie" === t[o].name) {
...
function checkSkipListCaching(e) {
    ...
    n.href = e.url;
    var o = cleanURL(n.hostname.toLowerCase()), r = Math.floor(Date.now() / 1e3), i = Object.keys(window.skipList);
    if (i && -1 != i.indexOf(o)) {
...
function invalidateSkipListCaching(e, t) {
    ...
    if (t) for(var o = 0; o < n.length; o++)window.skipList[n[o]].last_broker_call = 0;
    else {
...
function sendSHDataToServer(e, t, n, o) {
    if (isClusterURLAvailable()) {
        t = window.clusterUrl + "/flaggedSearches?search=" + window.btoa(e) + "&url=" + window.btoa(t) + "&match=" + window.btoa(n) + "&domain=" + window.btoa(o) + "&extension_id=" + chrome.runtime.id;
...
function sendSocialPostToServer(e, t, n, o) {
    if (isClusterURLAvailable()) {
        o = window.clusterUrl + "/socialActivity?msg=" + window.btoa(encodeURIComponent(e)) + "&domain=" + window.btoa(t) + "&context=" + window.btoa(n) + "&url=" + window.btoa(o) + "&extension_id=" + chrome.runtime.id;
    ...
    return function() {
        ...
        e.enc.Base64 = {
            stringify: function(e) {
                ...
                e.clamp();
                for(var r = [], i = 0; i < n; i += 3)for(var s = (t[i >>> 2] >>> 24 - i % 4 * 8 & 255) << 16 | (t[i + 1 >>> 2] >>> 24 - (i + 1) % 4 * 8 & 255) << 8 | t[i + 2 >>> 2] >>> 24 - (i + 2) % 4 * 8 & 255, a = 0; a < 4 && i + .75 * a < n; a++)r.push(o.charAt(s >>> 6 * (3 - a) & 63));
                var c = o.charAt(64);
        ...
        var a = i.MD5 = r.extend({
            ...
            _doProcessBlock: function(e, t) {
                ...
                var i = this._hash.words, a = e[t + 0], l = e[t + 1], h = e[t + 2], w = e[t + 3], g = e[t + 4], p = e[t + 5], m = e[t + 6], v = e[t + 7], y = e[t + 8], b = e[t + 9], _ = e[t + 10], O = e[t + 11], x = e[t + 12], k = e[t + 13], S = e[t + 14], C = e[t + 15], B = i[0], L = i[1], R = i[2], U = i[3];
                L = f(L = f(L = f(L = f(L = u(L = u(L = u(L = u(L = d(L = d(L = d(L = d(L = c(L = c(L = c(L = c(L, R = c(R, U = c(U, B = c(B, L, R, U, a, 7, s[0]), L, R, l, 12, s[1]), B, L, h, 17, s[2]), U, B, w, 22, s[3]), R = c(R, U = c(U, B = c(B, L, R, U, g, 7, s[4]), L, R, p, 12, s[5]), B, L, m, 17, s[6]), U, B, v, 22, s[7]), R = c(R, U = c(U, B = c(B, L, R, U, y, 7, s[8]), L, R, b, 12, s[9]), B, L, _, 17, s[10]), U, B, O, 22, s[11]), R = c(R, U = c(U, B = c(B, L, R, U, x, 7, s[12]), L, R, k, 12, s[13]), B, L, S, 17, s[14]), U, B, C, 22, s[15]), R = d(R, U = d(U, B = d(B, L, R, U, l, 5, s[16]), L, R, m, 9, s[17]), B, L, O, 14, s[18]), U, B, a, 20, s[19]), R = d(R, U = d(U, B = d(B, L, R, U, p, 5, s[20]), L, R, _, 9, s[21]), B, L, C, 14, s[22]), U, B, g, 20, s[23]), R = d(R, U = d(U, B = d(B, L, R, U, b, 5, s[24]), L, R, S, 9, s[25]), B, L, w, 14, s[26]), U, B, y, 20, s[27]), R = d(R, U = d(U, B = d(B, L, R, U, k, 5, s[28]), L, R, h, 9, s[29]), B, L, v, 14, s[30]), U, B, x, 20, s[31]), R = u(R, U = u(U, B = u(B, L, R, U, p, 4, s[32]), L, R, y, 11, s[33]), B, L, O, 16, s[34]), U, B, S, 23, s[35]), R = u(R, U = u(U, B = u(B, L, R, U, l, 4, s[36]), L, R, g, 11, s[37]), B, L, v, 16, s[38]), U, B, _, 23, s[39]), R = u(R, U = u(U, B = u(B, L, R, U, k, 4, s[40]), L, R, a, 11, s[41]), B, L, w, 16, s[42]), U, B, m, 23, s[43]), R = u(R, U = u(U, B = u(B, L, R, U, b, 4, s[44]), L, R, x, 11, s[45]), B, L, C, 16, s[46]), U, B, h, 23, s[47]), R = f(R, U = f(U, B = f(B, L, R, U, a, 6, s[48]), L, R, v, 10, s[49]), B, L, S, 15, s[50]), U, B, p, 21, s[51]), R = f(R, U = f(U, B = f(B, L, R, U, x, 6, s[52]), L, R, w, 10, s[53]), B, L, _, 15, s[54]), U, B, l, 21, s[55]), R = f(R, U = f(U, B = f(B, L, R, U, y, 6, s[56]), L, R, C, 10, s[57]), B, L, m, 15, s[58]), U, B, k, 21, s[59]), R = f(R, U = f(U, B = f(B, L, R, U, g, 6, s[60]), L, R, O, 10, s[61]), B, L, h, 15, s[62]), U, B, b, 21, s[63]), i[0] = i[0] + B | 0, i[1] = i[1] + L | 0, i[2] = i[2] + R | 0, i[3] = i[3] + U | 0;
            },
        ...
        var t = l, n = t.lib, o = n.WordArray, r = n.Hasher, i = t.algo, s = o.create([
            ...
            _doProcessBlock: function(e, t) {
                ...
                var i, l, h, b, _, O, x, k, S, C, B, L = this._hash.words, R = u.words, U = f.words, N = s.words, A = a.words, T = c.words, E = d.words;
                O = i = L[0], x = l = L[1], k = h = L[2], S = b = L[3], C = _ = L[4];
                for(n = 0; n < 80; n += 1)B = i + e[t + N[n]] | 0, B += n < 16 ? w(l, h, b) + R[0] : n < 32 ? g(l, h, b) + R[1] : n < 48 ? p(l, h, b) + R[2] : n < 64 ? m(l, h, b) + R[3] : v(l, h, b) + R[4], B = (B = y(B |= 0, T[n])) + _ | 0, i = _, _ = b, b = y(h, 10), h = l, l = B, B = O + e[t + A[n]] | 0, B += n < 16 ? v(x, k, S) + U[0] : n < 32 ? m(x, k, S) + U[1] : n < 48 ? p(x, k, S) + U[2] : n < 64 ? g(x, k, S) + U[3] : w(x, k, S) + U[4], B = (B = y(B |= 0, E[n])) + C | 0, O = C, C = S, S = y(k, 10), k = x, x = B;
                B = L[1] + h + S | 0, L[1] = L[2] + b + C | 0, L[2] = L[3] + _ + O | 0, L[3] = L[4] + i + x | 0, L[4] = L[0] + l + k | 0, L[0] = B;
            },
            _doFinalize: function() {
                var e = this._data, t = e.words, n = 8 * this._nDataBytes, o = 8 * e.sigBytes;
        ...
        var e = l, t = e.lib, n = t.Base, o = t.WordArray, r = e.algo, i = r.SHA1, s = r.HMAC, a = r.PBKDF2 = n.extend({
            ...
            compute: function(e, t) {
                for(var n = this.cfg, r = s.create(n.hasher, e), i = o.create(), a = o.create([
                    1
                ]), c = i.words, l = a.words, d = n.keySize, u = n.iterations; c.length < d;){
        ...
        var f = s.SHA3 = r.extend({
            ...
            _doProcessBlock: function(e, t) {
                ...
                for(var l = 0; l < 24; l++){
                    ...
                    for(var _ = 1; _ < 25; _++){
                        var O = (L = n[_]).high, x = L.low, k = a[_];
                        k < 32 ? (h = O << k | x >>> 32 - k, w = x << k | O >>> 32 - k) : (h = x << k - 32 | O >>> 64 - k, w = O << k - 32 | x >>> 64 - k);
                        var S = u[c[_]];
                        S.high = h, S.low = w;
                    }
                    var C = u[0], B = n[0];
                    C.high = B.high, C.low = B.low;
                    for(f = 0; f < 5; f++)for(g = 0; g < 5; g++){
                        var L = n[_ = f + 5 * g], R = u[_], U = u[(f + 1) % 5 + 5 * g], N = u[(f + 2) % 5 + 5 * g];
                        L.high = R.high ^ ~U.high & N.high, L.low = R.low ^ ~U.low & N.low;
                    }
                    L = n[0];
                    var A = d[l];
        ...
        var d = i.SHA512 = t.extend({
            ...
            _doProcessBlock: function(e, t) {
                for(var n = this._hash.words, o = n[0], r = n[1], i = n[2], s = n[3], l = n[4], d = n[5], u = n[6], f = n[7], h = o.high, w = o.low, g = r.high, p = r.low, m = i.high, v = i.low, y = s.high, b = s.low, _ = l.high, O = l.low, x = d.high, k = d.low, S = u.high, C = u.low, B = f.high, L = f.low, R = h, U = w, N = g, A = p, T = m, E = v, I = y, D = b, F = _, H = O, q = x, P = k, M = S, W = C, z = B, j = L, V = 0; V < 80; V++){
                    var G, K, J = c[V];
                    if (V < 16) K = J.high = 0 | e[t + 2 * V], G = J.low = 0 | e[t + 2 * V + 1];
                    else {
                        ...
                        K = (K = (K = Q + se + ((G = $ + ae) >>> 0 < $ >>> 0 ? 1 : 0)) + oe + ((G += re) >>> 0 < re >>> 0 ? 1 : 0)) + le + ((G += de) >>> 0 < de >>> 0 ? 1 : 0), J.high = K, J.low = G;
                    }
                    var ue, fe = F & q ^ ~F & M, he = H & P ^ ~H & W, we = R & N ^ R & T ^ N & T, ge = U & A ^ U & E ^ A & E, pe = (R >>> 28 | U << 4) ^ (R << 30 | U >>> 2) ^ (R << 25 | U >>> 7), me = (U >>> 28 | R << 4) ^ (U << 30 | R >>> 2) ^ (U << 25 | R >>> 7), ve = (F >>> 14 | H << 18) ^ (F >>> 18 | H << 14) ^ (F << 23 | H >>> 9), ye = (H >>> 14 | F << 18) ^ (H >>> 18 | F << 14) ^ (H << 23 | F >>> 9), be = a[V], _e = be.high, Oe = be.low, xe = z + ve + ((ue = j + ye) >>> 0 < j >>> 0 ? 1 : 0), ke = me + ge;
                    z = M, j = W, M = q, W = P, q = F, P = H, F = I + (xe = (xe = (xe = xe + fe + ((ue = ue + he) >>> 0 < he >>> 0 ? 1 : 0)) + _e + ((ue = ue + Oe) >>> 0 < Oe >>> 0 ? 1 : 0)) + K + ((ue = ue + G) >>> 0 < G >>> 0 ? 1 : 0)) + ((H = D + ue | 0) >>> 0 < D >>> 0 ? 1 : 0) | 0, I = T, D = E, T = N, E = A, N = R, A = U, R = xe + (pe + we + (ke >>> 0 < me >>> 0 ? 1 : 0)) + ((U = ue + ke | 0) >>> 0 < ue >>> 0 ? 1 : 0) | 0;
                }
                w = o.low = w + U, o.high = h + R + (w >>> 0 < U >>> 0 ? 1 : 0), p = r.low = p + A, r.high = g + N + (p >>> 0 < A >>> 0 ? 1 : 0), v = i.low = v + E, i.high = m + T + (v >>> 0 < E >>> 0 ? 1 : 0), b = s.low = b + D, s.high = y + I + (b >>> 0 < D >>> 0 ? 1 : 0), O = l.low = O + H, l.high = _ + F + (O >>> 0 < H >>> 0 ? 1 : 0), k = d.low = k + P, d.high = x + q + (k >>> 0 < P >>> 0 ? 1 : 0), C = u.low = C + W, u.high = S + M + (C >>> 0 < W >>> 0 ? 1 : 0), L = f.low = L + j, f.high = B + z + (L >>> 0 < j >>> 0 ? 1 : 0);
            },
            _doFinalize: function() {
                var e = this._data, t = e.words, n = 8 * this._nDataBytes, o = 8 * e.sigBytes;
        ...
        var t = l, n = t.lib, o = n.Base, r = n.WordArray, i = n.BufferedBlockAlgorithm, s = t.enc, a = (s.Utf8, s.Base64), c = t.algo.EvpKDF, d = n.Cipher = i.extend({
            ...
            execute: function(e, t, n, o) {
                ...
                var i = c.create({
                    keySize: t + n
                }).compute(e, o), s = r.create(i.words.slice(t), 4 * n);
    ...
    1: [
        function(e, t, n) {
            !function(o) {
                ...
                var a = 4294967296, c = a * a, l = c / 2, d = r.fromInt(1 << 24);
...
function notifyProxyIdentified(e) {
    if (isClusterURLAvailable() && !identifiedWebsites.includes(e.proxyUrl)) {
        ...
        n.append("domain", e.proxyUrl), n.append("proxyFamily", e.proxyName), n.append("rules", JSON.stringify(e.targetElements));
        try {
            t.send(n), identifiedWebsites.push(e.proxyUrl);
        } catch (e) {
...
function getSocialPost(e, t) {
    ...
    if (-1 != e.url.indexOf("twitter.com") && (-1 != e.url.indexOf(window.twitterMessageURI) || -1 != e.url.indexOf("graphql") && -1 != e.url.indexOf("CreateTweet")) && "POST" == e.method && "xmlhttprequest" == e.type) {
        var r = "";
        void 0 !== e.requestBody.raw ? ("" == (r = extractTweet(o = buff2StrWithEmoji(e.requestBody.raw[0].bytes))) && (r = extractPost(o, "&status=", "&tagged_users")), r = r.replaceAll("\n", " "), r = encodeURIComponent(r), n = window.btoa(r.toLowerCase())) : (r = (r = e.requestBody.formData.status[0]).replaceAll("\n", " "), r = encodeURIComponent(r), n = window.btoa(r.toLowerCase()));
    }
    -1 == t.indexOf("facebook.com") || -1 == t.indexOf("updatestatus") && -1 == t.indexOf("webgraphql") || "POST" != e.method || "xmlhttprequest" != e.type || (o = buff2StrWithEmoji(e.requestBody.raw[0].bytes), i = (i = extractFBPost(decodeURIComponent(o))).replaceAll("\n", " "), i = encodeURIComponent(i), n = window.btoa(i.toLowerCase()));
    ...
    if (-1 != t.indexOf("google.co") && -1 != t.indexOf("/PlusAppUi/mutate") && "POST" == e.method && "xmlhttprequest" == e.type) {
        var s = "";
        if (void 0 !== e.requestBody.raw) s = extractPost(o = buff2StrWithEmoji(e.requestBody.raw[0].bytes), "f.req=%5B%22", "%22%2C%22oz"), n = window.btoa(decodeURIComponent(s.toLowerCase()));
        else {
...
function extractFBPost(e) {
    var t, n, o;
    for(n = 0, o = (t = e.split("&")).length; n < o; n++)if (0 == t[0].indexOf("variables=")) return JSON.parse(t[0].substr(10)).input.message.text;
}
...
function getYoutubeSearchURL(e, t) {
    if (void 0 !== e.requestBody.raw) {
        var n = buff2StrWithEmoji(e.requestBody.raw[0].bytes), o = JSON.parse(n);
        void 0 !== o.query && (t = e.initiator + "/results?search_query=" + encodeURIComponent(o.query));
    }
    return t;
}
    ...
    if (doBrokerForClassroom() && (d = ""), d) if (-1 != d.indexOf("ALLOW") && 0 == skipCacheAndLogAlways(e, o)) wellPathWidgBg.triggerWidgetDisplay();
        ...
        if (window.lastBrokeredRequest = o, "unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) {
            (f = createNonBlockingRequest("get", u)).onerror = function() {
                ...
                if (void 0 !== l && l || setClearCacheCookie(r), wellPathWidgBg.triggerWidgetDisplay(), 0 != (d = f.responseText.trim()).indexOf("FAILED_OPEN:")) {
                    if (-1 == d.toLowerCase().indexOf("<html")) {
                        var n = d.split(":"), o = n[0], i = n[1], s = n[2], a = n[3], c = n[2], u = !1;
                        if (0 == isNaN(c) && c >= 0) {
                            var h = Long.fromString(c, !0).shiftRight(0).toNumber(), w = Long.fromNumber(Math.pow(2, 36)).shiftRight(0).toNumber();
        ...
        if (selfClusterCheckBeforeBroker(), null != c && (w = c.channelId, h = c.videoId, g = c.category), u = window.clusterUrl + "/broker?useremail=" + window.userEmail + "&reason=crextn&host=" + e + "&url=" + t + "&msg=" + n + "&ver=" + window.version + "&cu=" + window.clusterUrl + "&uf=" + window.userFound + "&cf=" + window.clusterFound + (s ? "&subframe=1" : "") + ("" != i ? "&frameHost=" + i : "") + (null != w ? "&channelID=" + w : "") + (null != h ? "&videoID=" + h : "") + (null != g ? "&category=" + encodeURIComponent(g) : "") + "&extension_id=" + chrome.runtime.id, window.geolocation && (u = u + "&lat=" + window.geoLat + "&lng=" + window.geoLng), l && (u += "&rebroker=1"), 0 == s) {
            ...
            let t = !1;
            if (isSeachRequest(e, o) && stripSafeSearchPramas(o) == window.lastBrokeredRequest && (t = !0), window.lastBrokeredRequest = o, !t && "unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) var f = createBlockingRequest("get", u);
        }
        if ("unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) {
            f.onerror = function() {
                d = "ERROR:-1:-1:-1:-1:-1:-1";
                ...
                if (0 != (d = f.responseText.trim()).indexOf("FAILED_OPEN:")) {
                    ...
                    var o = !1;
                    if (0 == isNaN(n) && n >= 0) {
                        var c = Long.fromString(n, !0).shiftRight(0).toNumber(), u = Long.fromNumber(Math.pow(2, 36)).shiftRight(0).toNumber();
                        Long.fromNumber(c).and(Math.pow(2, 36)).shiftRight(0).toNumber() == u && (o = !0);
                    }
                    if (void 0 !== l && l || setClearCacheCookie(r), wellPathWidgBg.triggerWidgetDisplay(), setClassroomCookies(), -1 == d.indexOf("DENY") && -1 == d.indexOf("PAUSE")) try {
...
function getRespArr(e, t, n, o, r = "", i = !1) {
    ...
    if (doBrokerForClassroom() && (s = ""), s) wellPathWidgBg.triggerWidgetDisplay();
        ...
        c.onerror = function() {
            ...
            if (wellPathWidgBg.triggerWidgetDisplay(), setClearCacheCookie(), setClassroomCookies(), 0 != (s = c.responseText.trim()).indexOf("FAILED_OPEN:")) {
                ...
                var r = !1;
                if (0 == isNaN(n) && n >= 0) {
                    var i = Long.fromString(n, !0).shiftRight(0).toNumber(), a = Long.fromNumber(Math.pow(2, 36)).shiftRight(0).toNumber();
                    Long.fromNumber(i).and(Math.pow(2, 36)).shiftRight(0).toNumber() == a && (r = !0);
                }
                if (-1 == s.indexOf("DENY") && 0 == skipCacheAndLogAlways(e, o)) try {
                    -1 == s.indexOf("WL_URL") || void 0 !== window.crextnBasegene_bit0 && window.crextnBasegene_bit0 == window.bit0 ? void 0 !== window.crextnBasegene_bit0 && window.crextnBasegene_bit0 == window.bit0 || sessionStorage.setItem(e, s) : sessionStorage.setItem(window.atob(t).replace(/(^\w+:|^)\/\//, ""), s), 0 == r && (void 0 !== window.crextnBasegene_bit0 && window.crextnBasegene_bit0 == window.bit0 || sessionStorage.setItem(e, s)), setCookie("last_broker_call", Math.floor(Date.now() / 1e3), 5);
                } catch (e) {
                    sessionStorage.clear();
                }
            } else {
...
function putURLCache(e, t, n, o) {
    -1 == e.indexOf("WL_URL") || void 0 !== window.crextnBasegene_bit0 && window.crextnBasegene_bit0 == window.bit0 ? 0 != o || void 0 !== window.crextnBasegene_bit0 && window.crextnBasegene_bit0 == window.bit0 || sessionStorage.setItem(n, e + "," + (new Date).getTime() / 1e3) : (resultURL = window.atob(t).replace(/(^\w+:|^)\/\//, ""), sessionStorage.setItem(resultURL, e + "," + (new Date).getTime() / 1e3));
}
...
function setupListener() {
    chrome.tabs.onCreated.addListener(function(e) {
        ...
        if (e.requestHeaders.forEach(function(e) {
            ...
            if (1 == o) {
                ...
                return this.iframeResp.length > 0 && "DENY" == this.iframeResp[0] ? (this.iframeResp = "", {
                    ...
                    requestHeaders: e.requestHeaders
                }) : "YT" == f && !0 === window.checkYouTube ? (2 == w ? e.requestHeaders.push({
        ...
        lastKnownState != e && ("active" == e && "idle" != lastKnownState && (sessionStorage.clear(), window.featureConfig && 1 == window.featureConfig.reload_tabs ? rebrokerLoadedTabs() : chrome.windows.getAll({
            ...
            for(var t = 0; t < e.length; t++)for(var n = 0; n < e[t].tabs.length; n++)"chrome://" != e[t].tabs[n].url.substring(0, 9) && tabCheck.forEach(function(o) {
        ...
        }) : "proxyDetection" == e.name && e.onMessage.addListener(function(t, n) {
    ...
    if ("sub_frame" == e.type && "file://" == e.initiator && 0 === e.url.indexOf("http") && (r = 1), 1 == r && (r = checkSkipListCaching(e)), 1 != r) window.youtubeLastCheck = null, n.indexOf("youtube") && (window.ytURL = n, "UNKNOWN_SCHOOL" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && (null == window.ytOptionsLastCheck || Math.floor(Date.now() / 1e3) - window.ytOptionsLastCheck >= 3600) && getYTOptions(), chrome.runtime.onConnect.addListener(function(t) {
        ...
        "gmaps" == e.name && e.onMessage.addListener(function(e, t) {
            if (e.url != window.lastMapsUrl) {
                ...
                o.href = e.url;
                let r = getRespArrTabs(c = normalizeHostname(c = o.hostname.toLowerCase()), n, "", e.url, t.sender.tab.id, "", !1, this), i = r[0], s = r[1];
                r[2];
        ...
        var v = !1;
        if ("SS" == h && (!1 !== (p = takeSafeSearchAction(c, o)) && (o = p), v = !0), "CC" == g && (!1 !== (m = takeCreativeCommonImageSearchAction(o)) && (o = m), v = !0), -1 !== n.indexOf("youtube.") && "REFWL" == g ? (window.refDomain = e.initiator, window.checkYouTube = !1) : -1 !== n.indexOf("youtube.") && (window.checkYouTube = !0), !0 === v) {
            ...
            } else if (-1 !== n.indexOf("yahoo.com") && -1 === n.indexOf("imgl=cc") || -1 !== n.indexOf("bing.") && -1 === n.indexOf("qft+filterui:licenseType-Any")) return {
                redirectUrl: o
            };
        }
    }
...
chrome.runtime.onConnect.addListener(function(e) {
    "gmeet" == e.name && e.onMessage.addListener(function(e, t) {
        if (e.url != previousMeetUrl) {
            ...
            let i = getRespArrTabs(lHostName, n, "", e.url, t.sender.tab.id, "", !1, this), s = i[0], a = i[1];
...
const wellPathWidgBg = function() {
    var e = null, t = 0, n = (n)=>{
        ...
        chrome.cookies.getAll({
            ...
            if (!r.length || "show" == r[1]) try {
                const o = {
                    ...
                    data: await (async ()=>new Promise((n, o)=>{
                            ...
                            try {
                                ...
                                if (r - t <= 5 && o("response was saved in last 5 seconds"), null != e && e.userEmail == userEmail && r - e.timestamp <= 1800) return console.debug("wpw valid content cache found. elapsed seconds:", r - e.timestamp), void n(e.content);
                ...
                void 0 !== n && n ? chrome.tabs.sendMessage(n, o) : chrome.tabs.query({}, (e)=>{
                    e.forEach((e, t)=>{
    ...
    return chrome.runtime.onMessage.addListener((e, o)=>{
        console.debug("wpw msg received", e, o), "object" == typeof e && void 0 !== e.action && void 0 !== e.source && void 0 !== o.tab.id && -1 != o.tab.id && o.tab.id && "well-path-widget" == e.source && ("ready" == e.action && n(o.tab.id), "ctaClicked" != e.action && "closed" != e.action || (function(e) {
            try {
                ...
                if ("unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) {
                    ...
                    r.setRequestHeader("Content-Type", "application/json"), r.onerror = function() {
...
function interceptPostRequest(e) {
    if (window.vectorExpansionRules) {
        ...
        if (0 != t.length) {
            var n = document.createElement("a");
            if (n.href = e.initiator, mainHost = cleanURL(n.hostname.toLowerCase()), t && -1 != t.indexOf(mainHost)) for(let t = 0; t < window.vectorExpansionRules[mainHost].length; t += 1)try {
                ...
                if (c.test(e.url)) {
                    if ("JSON_STR" == s) {
                        ...
                        if (jsonInfo = JSON.parse(n), Array.isArray(i)) for(let e = 0; e < i.length; e += 1)tempText = removeHTMLTags(i[e].split("|").reduce((e, t)=>e[t], jsonInfo)), l = l.length > 0 ? l + " " + tempText : tempText;
                        else l = removeHTMLTags(i.split("|").reduce((e, t)=>e[t], jsonInfo));
                    } else if ("ENCODED_STR" == s) {
                        if (buff = e.requestBody.raw[0].bytes, postContent = buff2StrWithEmoji(buff), Array.isArray(i)) for(let e = 0; e < i.length; e += 1)tempText = i[e].split("|").reduce((e, t)=>new URLSearchParams(e).get(t), postContent), l = l.length > 0 ? l + " " + tempText : tempText;
                        ...
                        let t = JSON.parse(s);
                        if (Array.isArray(i)) for(let e = 0; e < i.length; e += 1)"tumblr.com" == mainHost && "content" == i[e] ? tempText = removeHTMLTags(fetchStringFromJSONObj(t, "text")) : tempText = removeHTMLTags(i[e].split("|").reduce((e, t)=>e[t], t)), l = l.length > 0 ? l + " " + tempText : tempText;
                    ...
                    } else if (Array.isArray(i)) for(let t = 0; t < i.length; t += 1)tempText = removeHTMLTags(i[t].split("|").reduce((e, t)=>{
                        try {
